            ...
            <div class="col-sm-8 col-xl-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        Listado de Paises
                        <a href="<?= ROOT ?>modulos/paises/addPais.php" class="btn btn-primary">Crear Pais</a>
                    </div>
                    <div class="card-body">
                        <?php 
                            $mensajes = array(
                                0=>"No se pudo realizar la acción, comunicate con el administrador",
                                1=>"Se elimino correctamente el pais",
                                2=>"Se creo correctamente el pais",
                                3=>"Se actualizo correctamente el pais"
                            );
                                ...
                                <?php 
                                    ...
                                    foreach($result as $row) {
                                        echo "<tr>
                                                ...
                                                <td>".$row['nombre']."</td>
                                                <td>
                                                    <a href='editPais.php?id=".$row['id']."' class='btn btn-primary'>Modificar</a>
