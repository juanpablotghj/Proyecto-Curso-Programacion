<?php
    ...
    $result = $conexion->DatosEmpleados();
                    ...
                    <div class="card-body">
                        ...
                        <?php 
                            $mensajes = array(
                                ...
                                1=>"Se elimino correctamente el empleado",
                                2=>"Se creo correctamente el empleado",
                                3=>"Se actualizo correctamente el empleado"
                            );
                                ...
                                <?php 
                                    ...
                                    foreach($result as $row) {
                                        echo "<tr>
                                                ...
                                                <td>".$row['tipo']."</td>
                                                <td >
                                                    <a href='editEmpleado.php?id=".$row['id']."' class='btn btn-primary'>Modificar</a>
