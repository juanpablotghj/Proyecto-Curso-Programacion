            ...
            <div class="col-sm-8 col-xl-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        Listado de Clientes
                        <a href="<?= ROOT ?>modulos/clientes/addCliente.php" class="btn btn-primary">Crear Cliente</a>
                    </div>
                    <div class="card-body">
                        ...
                        <?php 
                            $mensajes = array(
                                ...
                                1=>"Se elimino correctamente el cliente",
                                2=>"Se creo correctamente el cliente",
                                3=>"Se actualizo correctamente el cliente"
                            );
                                ...
                                <?php 
                                    ...
                                    foreach($result as $row) {
                                        echo "<tr>
                                                ...
                                                <td>".$row['telefono']."</td>
                                                <td >
                                                    <a href='editCliente.php?id=".$row['id']."' class='btn btn-primary'>Modificar</a>
