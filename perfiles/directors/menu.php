        ...
        <ul class="navbar-nav mr-auto">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="<?= ROOT ?>modulos/empleados/empleados.php">Empleados</a>
                    <a class="dropdown-item" href="<?= ROOT ?>modulos/proveedores/proveedores.php">Proveedores</a>
                </div>
            </li>
        </ul>
        <ul class="navbar-nav">
