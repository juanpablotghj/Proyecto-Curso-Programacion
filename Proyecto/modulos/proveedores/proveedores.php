<?php
    ...
    $result = $conexion->DatosProveedores();
            ...
            <div class="col-sm-8 col-xl-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?= ROOT ?>modulos/proveedores/addProveedor.php" class="btn btn-primary">Crear Proveedor</a>
                    </div>
                    <div class="card-body">
                        ...
                        <?php 
                            $mensajes = array(
                                ...
                                1=>"Se elimino correctamente el proveedor",
                                2=>"Se creo correctamente el proveedor",
                                3=>"Se actualizo correctamente el proveedor"
                            );
                                ...
                                <?php 
                                    ...
                                    foreach($result as $row) {
                                        echo "<tr>
                                                ...
                                                <td>".$row['ciudad']."</td>
                                                <td >
                                                    <a href='editProveedor.php?id=".$row['id']."' class='btn btn-primary'>Modificar</a>
