<?php
    ...
    $inventariosmateriasprimas = $conexion->DatosMateriasPrimas();
            ...
            <div class="col-sm-8 col-xl-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <strong> Inventario de Materia Prima </strong>
                    </div>
                    <div class="card-body">
                        ...
                        <table class='table table-striped'>
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    foreach($inventariosmateriasprimas as $inventario) {
                                        ...
                                        $inventario = $conexion->ConsultarInventarioMateria($inventario['codbarra']);
