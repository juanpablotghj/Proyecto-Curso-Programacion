<?php
    ...
    $result = $conexion->DatosProgramaciones();
            ...
            <div class="col-sm-8 col-xl-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?= ROOT ?>modulos/programaciones/addProgramacion.php" class="btn btn-primary">Crear Programacion</a>
                    </div>
                    <div class="card-body">
                        ...
                        <?php 
                            $mensajes = array(
                                ...
                                1=>"Se elimino correctamente la programarion",
                                2=>"Se creo correctamente la programarion",
                                3=>"Se actualizo correctamente la programarion"
                            );
                                ...
                                <?php 
                                    ...
                                    foreach($result as $row) {
                                        echo "<tr>
                                                ...
                                                <td>".$row['cantidad']."</td>
                                                <td >
                                                    <a href='editProgramacion.php?id=".$row['id']."' class='btn btn-primary'>Modificar</a>
